...
public class ArticleCommentService {
    ...
    public void saveArticleComment(ArticleCommentDto dto) {
        try {
            Article article = articleRepository.getReferenceById(dto.articleId()); //댓글을 작성한 게시글 정보
            UserAccount userAccount = userAccountRepository.getReferenceById(dto.userAccountDto().userId()); //댓글 작성자 정보
